...
<head>
	<meta charset="utf-8">
	<base href="//localhost/wordpress/wp-content/themes/orangey/">
...
<script src="tinynav.min.js"></script>
	<title><?php wp_title( '| Institute for Innovation & Entrepreneurship', true, 'right' ); ?></title>
	<?php wp_head(); ?>
</head>
<body class="gradient">
	<div id="site-container">
		<header class="grid">
			...
			<div class="row naked_vert nav_container top_border">
				<div class="c10 orangebar grey_triangle naked_vert nav">
					<nav>
